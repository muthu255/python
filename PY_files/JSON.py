...
def getJSON ():
    ...
    import_file_path = filedialog.askopenfilename(initialdir='D:/')
    read_file = pd.read_json ("D:/employees.json")
...
def convertToCSV ():
    ...
    read_file.to_csv ("D:/employees.csv", index = None, header=True)
